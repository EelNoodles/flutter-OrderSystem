      ...
      routes: <String, WidgetBuilder>{'/combo': (_) => combo()},
        ...
        home: Scaffold(
          appBar: AppBar(
            ...
            title: Stack(
              children: [
                Text('選擇要傳情的商品與數量', style: TextStyle(fontWeight: FontWeight.bold,
                    foreground: Paint()
                      ..style = PaintingStyle.stroke
                      ..strokeWidth = 3
                      ..color = Colors.grey.shade700!)),
                Text('選擇要傳情的商品與數量', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),)
              ],
            )
          ),
          body: MainProduct(),
      ...
      children: [
        Container(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: db.collection("MainDessert").orderBy("Price").snapshots(),
                              ...
                              children: [
                                ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(e.get("dessertImage"), fit: BoxFit.cover),
                                    )
                                ),
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text(e.get("dessertDescribe"), style:
                                ...
                                Container(
                                  ...
                                  child: Text(e.get("dessertName"), style:
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async{
                List<Map> amountList = [];
                int index = 0;
                await db.collection("MainDessert").orderBy("Price").get().then((querySnapshot) {
                  for (var docSnapshot in querySnapshot.docs) {
                    Map<String, String> _amountMap = {};
                    if(repo.getCount(context, index) != 0){
                      _amountMap["id"] = docSnapshot.id.toString();
                      _amountMap["amount"] = repo.getCount(context, index).toString();
                      amountList.add(_amountMap);
                    }
                    index ++;
                  }
                });
                if(amountList.isEmpty){
                  Fluttertoast.showToast(msg: "至少選擇1份主要餐點！", toastLength: Toast.LENGTH_SHORT);
                }else{
                  Navigator.of(context).pushNamed('/combo', arguments: amountList);
                }
              },
              child: const Text("下一步加購套餐",style: TextStyle(
